...
<html>
    ...
    <body>
        <div style="background-image: url('<c:url value="/images/background/product-background.jpg"/>')">
                ...
                <div  class="dropdown mt-90">
                    <i style="margin: 38px">
                        <a class="btn btn-secondary dropdown-toggle mt-30 pl-30" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                            <h3 style="color: #ffffcc"> Acoustic</h3>
            ...
            <!--                <div class="row">
                                <div class="col-6">
                                    <img style="width: 90%" src="<c:url  value="/images/aucoutic/takamine-gd15ce-nat.jpg"/>"/>
                                    <a href="<c:url value="/product/takamine-gd15ce.do"/>"> TAKAMINE GD15C</a>
                                </div>
                                <div class="col-6">
                                    <img style="width: 90%" src="<c:url value="/images/aucoutic/fender-cd-60s.jpg"/>"/>
                                    <a href="<c:url value="/product/fender-cd-60s.do"/>"> FENDER CD 60s</a>
                                </div>
                            </div>-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="card mb-30"><a class="card-img-tiles" href="#" data-abc="true">
                                <div class="inner">
                                    <div class="main-img"><img src="<c:url  value="/images/aucoutic/takamine-gd15ce-nat.jpg"/>" alt="Category"></div>
                                </div>
                            </a>
                            <div class="card-body text-center">
                                <a class="card-title" href="<c:url value="/product/takamine-gd15ce.do"/>"> TAKAMINE GD15C</a>
                                <!--                            <h4 >Takamine GD10CE</h4>-->
                                <h5 class="text-muted">8,510,000</h5>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="card mb-30"><a class="card-img-tiles" href="#" data-abc="true">
                                <div class="inner">
                                    <div class="main-img"><img src="<c:url value="/images/aucoutic/fender-cd-60s.jpg"/>" alt="Category"></div>
                                </div>
                            </a>
                            <div class="card-body text-center">
                                <a class="card-title" href="<c:url value="/product/fender-cd-60s.do"/>"> FENDER CD 60s</a>
                                <h5 class="text-muted">5,950,000</h5>
                                <a class="btn btn-outline-primary btn-sm" href="#"
                                   data-abc="true">chạy vô cart</a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="card mb-30"><a class="card-img-tiles" href="#" data-abc="true">
                                <div class="inner">
                                    <div class="main-img"><img src="<c:url value="/images/aucoutic/tanglewood-twcrdce-400x400.jpg"/>" alt="Category"></div>
                                </div>
                            </a>
                            <div class="card-body text-center">
                                <a class="card-title" href="<c:url value="/product/Tanglewood-Dreadnought.do"/>"> TANGLEWOOD DREADNOUGHT</a>
                                <h5 class="text-muted">3,350,000</h5>
                                <a class="btn btn-outline-primary btn-sm" href="#"
                                   data-abc="true">chạy vô cart</a>
                            </div>
                        </div>
