...
<html>
    ...
    <body>
        <div style="background-image: url('<c:url value="/images/background/product-background.jpg"/>')">
                ...
                <div  class="dropdown mt-90">
                    <i style="margin: 38px">
                        <a class="btn btn-secondary dropdown-toggle mt-30 pl-30" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                            <h3 style="color: #ffffcc"> Synthesizer</h3>
            ...
            <!--        <div class="row">
                        <div class="col-6">
                            <img style="width: 90%" src="<c:url  value="/images/aucoutic/fender-venice.jpg"/>"/>
                            <a href="<c:url value="/product/fender-venice.do"/>"> FENDER VENICE</a>
                        </div>
                        <div class="col-6">
                            <img style="width: 90%" src="<c:url value="/images/aucoutic/roland-g-5.jpg"/>"/>
                            <a href="<c:url value="/product/roland-g-5.do"/>"> ROLAND G5</a>
                        </div>
                    </div>-->
                ...
                <div class="row">
                    ...
                    <!--                <div class="col-md-4 col-sm-6">
                                        <div class="card mb-30"><a class="card-img-tiles" href="#" data-abc="true">
                                                <div class="inner">
                                                    <div class="main-img"><img src="<c:url  value="/images/aucoutic/fender-venice.jpg"/>" alt="Category"></div>
                                                </div>
                                            </a>
                                            <div class="card-body text-center">
                                                <a class="card-title" href="<c:url value="/product/fender-venice.do"/>"> FENDER VENICE</a>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="card mb-30"><a class="card-img-tiles" href="#" data-abc="true">
                                <div class="inner">
                                    <div class="main-img"><img src="<c:url value="/images/aucoutic/roland-g-5.jpg"/>" alt="Category"></div>
                                </div>
                            </a>
                            <div class="card-body text-center">
                                <a class="card-title" href="<c:url value="/product/roland-g-5.do"/>"> ROLAND G5</a>
                                <h5 class="text-muted">2,500,000</h5>
                                <a class="btn btn-outline-primary btn-sm" href="#"
                                   data-abc="true">chạy vô cart</a>
                            </div>
                        </div>
