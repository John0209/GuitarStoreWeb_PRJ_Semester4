            ...
            <div class="wrapper1">
                ...
                <div class="product-info" >
                    <div class="product-text">
                        ...
                        <input type="hidden" name="page" value="/product/Takamine-TH90.do"/>
...
<div>
    ...
    <div >
        ...
        <p style="margin-left: 220px; margin-right: 220px; font-size: 22px">
            Takamine TH90 là ví dụ điển hình cho nghệ thuật luthier,
            cây đàn guitar cổ điển mang tên Master Luthier Mass Hirade
            được chế tác bằng tay trong cơ sở Takamine ở Nhật Bản. Mang đến 
            cho người dùng âm thanh hoàn hảo, trong một thiết kế phong cách</p>
        <div style="text-align: center">
            
        <img  src="<c:url value="/images/product/Takamine-TH90/2.jpg"/>" style="height:600px; width:600px;">
        </div>
    </div>
    <hr>
