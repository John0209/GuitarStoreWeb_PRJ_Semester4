...
<html>
                ...
                <div class="wrapper1">
                    ...
                    <div class="product-info" >
                        <div class="product-text">
                            ...
                            <input type="hidden" name="page" value="/product/fender-venice.do"/>
    ...
    <div>
        ...
        <div >
            ...
            <p style="margin-left: 220px; margin-right: 220px; font-size: 22px">Lấy cảm hứng từ những điểm tham quan giải trí và tinh thần vô 
                tư, độc đáo của Venice, California, chúng tôi đã tạo ra một 
                cây đàn ukulele soprano thu hút sự rung cảm của nó — Venice
                Ukulele. Nhờ kích thước cơ thể nhỏ gọn, thoải mái, Venice có
                thể di chuyển dễ dàng từ bãi biển đến phòng thu hoặc phòng 
                họp mà vẫn giữ được âm thanh cổ điển, nhẹ nhàng đã khiến ukulele
                trở thành "must-have" đối với người chơi ngày nay.</p>
            <div style="text-align: center">
                
            <img src="<c:url value="/images/aucoutic/fender-venice.jpg"/>" style="height:600px; width:600px"></p>
            </div>

            <p style="margin-left: 220px; margin-right: 220px; font-size: 22px"> Cần chữ "C" mỏng tạo cảm giác thoải mái khi cầm và dễ chơi,
                trong khi khoá đàn giúp việc thay dây trở nên dễ dàng. Phần 
                đầu có viền phong cách và phần đầu Tele® 4 trong dòng thêm 
                một đường gạch ngang độc đáo của phong cách Fender không thể trùng lặp.</p>

            <p style="margin-left: 220px; margin-right: 220px; font-size: 22px">Hãy để mọi sự quan tâm của bạn trôi ra biển, hòa mình vào âm 
                nhạc của lối đi bộ lót ván và sống cuộc sống trên bãi biển 
                quanh năm với Venice Ukulele.</p>
        </div>
        <hr>
