                ...
                <div class="wrapper1">
                    ...
                    <div class="product-info" >
                        <div class="product-text">
                            ...
                            <input type="hidden" name="page" value="/product/cordoba-45LTD.do"/>
...
<div>
    ...
    <ul>
        ...
        <div >
            ...
            <h2 style="text-align: center">Sơ lược về cây đàn guitar acoustic dây nylon giới hạn Cordoba 45:</h2>
            <div style="text-align: center">

                <img alt="" src="<c:url value="/images/aucoutic/cordoba-45LTD.jpg"/>" style="height:600px; width:600px">
            </div>

            <p style="margin-left: 220px; margin-right: 220px; font-size: 22px">- Dòng Espana</p>

            <p style="margin-left: 220px; margin-right: 220px; font-size: 22px">- Bổ sung Exotic tonewood</p>

            <p style="margin-left: 220px; margin-right: 220px; font-size: 22px">- Phiên bản giới hạn</p>

            <p style="margin-left: 220px; margin-right: 220px; font-size: 22px">45 Limited được làm thủ công tại Tây Ban Nha với mặt trên bằng vân sam châu Âu chắc chắn và mặt sau và hai bên bằng gỗ mun đen và trắng, mang đến kiểu dáng hiện đại và vẻ ngoài nổi bật cho một thiết kế</p>

            <p style="margin-left: 220px; margin-right: 220px; font-size: 22px">cổ điển của Tây Ban Nha. Một tông màu độc đáo, gỗ mun đen và trắng tôn lên giai điệu rõ ràng của một loại gỗ vân sam Châu Âu với phản ứng và độ bền âm trầm mạnh mẽ đáng ngạc nhiên. Các tính năng cao cấp bao gồm miếng đệm đầu và miếng đệm gót bằng gỗ mun màu đen và trắng, bảng ngón tay bằng gỗ mun, thanh giàn tác động kép, đai ốc và yên bằng xương, tuning machines mạ vàng cao cấp và dây Savarez.</p>
