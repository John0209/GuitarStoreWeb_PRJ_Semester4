            ...
            <div class="wrapper1">
                ...
                <div class="product-info" >
                    <div class="product-text">
                        ...
                        <input type="hidden" name="page" value="/product/Squier-Affinity-Series.do"/>
                        ...
                        <div class="high">  
                            ...
                            <p class="special">- 2 Pickup Singlecoil</p>
                            <p class="special">- 2-point tremolo bridge</p>
                            <p class="special">- Khoá lên dây đúc kín và chia trục</p>
                        </div> 
...
<li>2 Pickup Singlecoil</li>
<li>2-point tremolo bridge</li>
<li>Cần C mỏng và thoải mái</li>
<li>Khoá lên dây đúc kín và chia trục</li>
</ul>-->
    <div id="" class="">
        <h2 style="text-align: center"><strong>Mô Tả Sản Phẩm</strong></h2>
        <p style="margin-left: 220px; margin-right: 220px; font-size: 22px">Squier® Affinity Series™ Jazzmaster® mang đến thiết kế huyền thoại
            và giai điệu tinh túy cho người chơi guitar đầy khát vọng ngày nay.
            Dáng Jazzmaster® này có một số cải tiến thân thiện với người chơi 
            như thân mỏng và nhẹ, Neck hình chữ “C” mỏng và thoải mái, Bridge 
            tremolo 2 điểm cho hành động rung dây vượt trội cùng khoá lên dây 
            với trục chia cho điều chỉnh mượt mà, chính xác và dễ dàng chỉnh sửa.
            Được trang bị một cặp Pickup Squier Singlecoil với khả năng chuyển đổi
            3 vị trí cho sự đa dạng về thể loại âm thanh, cây đàn này sẵn sàng 
            đồng hành cùng bất kỳ người chơi nào ở bất kỳ giai đoạn nào.</p>
        <div style="text-align: center">

            <img src="<c:url value="/images/product/Squier-Affinity-Series/3.jpg"/>" style="height:234px; width:700px"></p>
        </div>
