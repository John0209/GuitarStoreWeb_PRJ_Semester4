...
<html>
    <head>
        ...
        <div class="wrapper">
            ...
            <input type="hidden" name="page" value="/product/takamine-gd15ce.do"/>
...
<!--    <h1>Guitar Information</h1>
    <form action="<c:url value="addCart.do"/>">
        ...
        <div >
            ...
            <p style="text-align:justify">Một sự lựa chọn tuyệt vời cho người mới
                bắt đầu hoặc bất kỳ ai đang tìm kiếm một cây đàn guitar acoustic-điện 
                hợp túi tiền với mức giá tuyệt vời. GD15CE với mặt trên bằng 
                vân sam, mặt sau và các cạnh bằng gỗ gụ tạo ra một sự ấm áp và
                ngọt ngào đáng chú ý vượt xa mức giá của nó. Tiền khuếch đại Takamine 
                TP-4T với bộ chỉnh tích hợp cho phép bạn tạo ra âm thanh 
                đặc trưng và giúp bạn sẵn sàng trên sân khấu.</p>
            </div>
            <p style="text-align:center"><img alt="" src="<c:url value="/images/aucoutic/takamine-gd15ce-nat.jpg"/>" style="height:800px; width:800px"></p>
        <hr>
        <div class="high1">  
